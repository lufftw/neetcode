...
This module handles the actual test execution logic, while display modules
focus on formatting.
...
from runner.core.executor import run_one_case, run_generated_case
from runner.utils.compare import normalize_output
from runner.display.reporter import truncate_input, format_validation_label, save_failed_case
from runner.analysis.memory_profiler import CaseMemoryMetrics, MethodMemoryMetrics
