---
title: LeetCode 核心模式心智圖（API Kernels → Patterns → Problems）
markmap:
  colorFreezeLevel: 2
  maxWidth: 300
---
...
- **輸入**：字串／陣列；連續視窗；常見 `k`、`target` 或需要的頻率對應表
...
- **成本模型**：每個索引單調移動（`L` 與 `R` 各自增加 ≤ n），因此指標操作為 $O(n)$。對應表／計數器操作每次更新期望 $O(1)$（雜湊），若用平衡樹則為 $O(\log \sigma)$。
- **狀態工具箱**：`hash_map` / `counter`，有時是整數和
- **標準掛鉤**：`on_enter(right)`, `on_exit(left)`, `is_valid()`, `score(window)`
...
| 題目 | 不變量 | 狀態 | 視窗大小 | 目標 |
|---------|-----------|-------|-------------|------|
| 🔥 [LeetCode 76 - Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0076_minimum_window_substring.py) (H) - Minimum Window Substring | 涵蓋 `t` 的所有需求 | need/have 對應表 | 可變 | 最小化 |
| 🔥 [LeetCode 3 - Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0003_longest_substring_without_repeating_characters.py) (M) - Longest Substring Without Repeating Characters | 全部不重複 | `last_index` 對應表 | 可變 | 最大化 |
| ⭐ [LeetCode 438 - Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0438_find_all_anagrams_in_a_string.py) (M) - Find All Anagrams in a String | 精確多重集合匹配 | freq + matched count | 固定 | 全部位置 |
| ⭐ [LeetCode 567 - Permutation in String](https://leetcode.com/problems/permutation-in-string/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0567_permutation_in_string.py) (M) - Permutation in String | 精確多重集合匹配 | freq + matched count | 固定 | 是否存在 |
| ⭐ [LeetCode 340 - Longest Substring with At Most K Distinct Characters](https://leetcode.com/problems/longest-substring-with-at-most-k-distinct-characters/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0340_longest_substring_with_at_most_k_distinct.py) (H) - Longest Substring with At Most K Distinct Characters | ≤ K 種不同字元 | freq 對應表 | 可變 | 最大化 |
| ⭐ [LeetCode 209 - Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0209_minimum_size_subarray_sum.py) (M) - Minimum Size Subarray Sum | sum ≥ target | 整數和 | 可變 | 最小化 |

### sliding_window_unique
- **不變量**：==視窗內沒有重複==
- **狀態**：`last_seen_index[char]`（jump-left 最佳化）
...
- **錨點題**
  - [ ] 🔥 [LeetCode 215 - Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0215_kth_largest_element_in_an_array.py) (M) - Kth Largest Element in an Array（雙路徑：heap vs quickselect）
...
| 形狀 | 你追蹤什麼 | 經典技巧 | 錨點 |
|------|-----------------|-----------------|--------|
| 排列 | `used[]` | 每個元素只用一次 | 🔥 [LeetCode 46 - Permutations](https://leetcode.com/problems/permutations/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0046_permutations.py) (M) - Permutations |
| 排列 + 重複 | `used[]` + sort | 若前一個未用則跳過 | ⭐ [LeetCode 47 - Permutations II](https://leetcode.com/problems/permutations-ii/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0047_permutations_ii.py) (M) - Permutations II |
| 子集合 | `start_index` | 收集每個節點 | ⭐ [LeetCode 78 - Subsets](https://leetcode.com/problems/subsets/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0078_subsets.py) (M) - Subsets |
| 子集合 + 重複 | `start_index` + sort | 同層跳過 | ⭐ [LeetCode 90 - Subsets II](https://leetcode.com/problems/subsets-ii/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0090_subsets_ii.py) (M) - Subsets II |
| 組合 | `start_index` + size | size==k 時停止 | ⭐ [LeetCode 77 - Combinations](https://leetcode.com/problems/combinations/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0077_combinations.py) (M) - Combinations |
| 目標總和 | `remaining` | remaining<0 就剪枝 | ⭐ [LeetCode 39 - Combination Sum](https://leetcode.com/problems/combination-sum/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0039_combination_sum.py) (M) - Combination Sum /40/216 |
| 限制滿足 | constraint sets | 傳播限制條件 | 🔥 [LeetCode 51 - N-Queens](https://leetcode.com/problems/n-queens/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0051_n_queens.py) (H) - N-Queens /52 |
| 格子路徑 | visited 標記 | 回來時復原 | ⭐ [LeetCode 79 - Word Search](https://leetcode.com/problems/word-search/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0079_word_search.py) (M) - Word Search |
| 字串切割 | 切割位置 | 驗證片段 | ⭐ [LeetCode 93 - Restore IP Addresses](https://leetcode.com/problems/restore-ip-addresses/description/) · [Solution](https://github.com/lufftw/neetcode/blob/main/solutions/0093_restore_ip_addresses.py) (M) - Restore IP Addresses /131 |
