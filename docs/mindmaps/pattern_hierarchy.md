...
- 🟡 [LeetCode 3 - Longest Substring Without Repeating Characters](../../solutions/0003_longest_substring_without_repeating_characters.py) — `O(n) time, O(min(n, Σ)) space`
...
- 🟡 [LeetCode 994 - Rotting Oranges](../../solutions/0994_rotting_oranges.py) — `O(m*n) time, O(m*n) space`
...
- 🔴 [LeetCode 23 - Merge k Sorted Lists](../../solutions/0023_merge_k_sorted_lists.py) — `O(N log k) time, O(k) space`
...
- 🔴 [LeetCode 4 - Median of Two Sorted Arrays](../../solutions/0004_median_of_two_sorted_arrays.py) — `O(m+n) time, O(1) space`
...
- 🔴 [LeetCode 51 - N-Queens](../../solutions/0051_n_queens.py) — `O(n!) time`
...
- 🔴 [LeetCode 25 - Reverse Nodes in k-Group](../../solutions/0025_reverse_nodes_in_k_group.py) — `O(N) time, O(1) space`
...
- 🟢 [LeetCode 1 - Two Sum](../../solutions/0001_two_sum.py) — `O(n) time, O(n) space`
