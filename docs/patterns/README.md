...
> **Generator**: `tools/pattern-docs/generate_pattern_docs.py`
...
python tools/pattern-docs/generate_pattern_docs.py --all

# Validate only (no write)
python tools/pattern-docs/generate_pattern_docs.py --validate
```
...
```bash
python tools/pattern-docs/generate_pattern_docs.py --pattern new_kernel
```
...
*Last updated: Auto-generated by `tools/pattern-docs/generate_pattern_docs.py`*
