...
**Cache:**
- Location: `tools/leetcode-api/crawler/.cache/leetcode_problems.json`
- Expiry: 7 days (auto-checked)
- Generated by: `tools/leetcode-api/crawler/sync_leetcode_data.py`
...
- [Data sync tool](tools/leetcode-api/crawler/sync_leetcode_data.py)
