...
Usage:
    python tools/mindmaps/generate_mindmaps.py                     # Generate all (MD only)
    python tools/mindmaps/generate_mindmaps.py --html              # Generate MD + HTML
    python tools/mindmaps/generate_mindmaps.py --type pattern      # Generate specific type
    python tools/mindmaps/generate_mindmaps.py --list              # List available types
    python tools/mindmaps/generate_mindmaps.py --convert file.md   # Convert MD to HTML
"""
...
def generate_index(output_dir: Path, generated_types: list[str]) -> None:
    ...
    lines.extend([
        ...
        "---\n",
        "*Auto-generated by `tools/mindmaps/generate_mindmaps.py`*",
    ])
