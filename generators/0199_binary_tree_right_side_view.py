# generators/0199_binary_tree_right_side_view.py
"""
Test Case Generator for Problem 0199 - Binary Tree Right Side View
...
def generate(count: int = 10, seed: Optional[int] = None) -> Iterator[str]:
    """Generate random test cases for Binary Tree Right Side View."""
    if seed is not None:
        random.seed(seed)
